class EmailService::Sendgrid < EmailService::Base
  ...
  def send_email(object)
    ...
    from = SendGrid::Email.new(email: 'hello@chargezen.com', name: (@email_notification.from_name || @email_notification.setting.store_name || shopify_shop.name))
    ...
    mail.reply_to = SendGrid::Email.new(email: 'hello@ethey.com', name: (@email_notification.from_name || @email_notification.setting.store_name || shopify_shop.name))
