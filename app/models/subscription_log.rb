class SubscriptionLog < ApplicationRecord
  ...
  enum action_type: %i[unchanged skip swap restart upsell delay billing shipping cancel pause resume info one_time_order opt_in upgrade downgrade quantity meal_selection]
