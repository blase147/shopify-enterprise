                ...
                <Card title="Upsell Campaign" sectioned>
                  <FormLayout>
                    ...
                    <FormLayout.Group>
                      ...
                      <div className="offer-description-v2">
                        <TextContainer>
                          <p className="offer-title">
                            Elementum Aliquam Potenti Sed Pellentesque
                          </p>

                          <Heading>$40</Heading>
                          <p className="countdown">
                            10:00 left to claim this offer
                          </p>
                          <p>
                          ...
                          <div className="d-flex child-full-width">
                            <div className="mr-16 ">
                              <Select label="Quantity" />
                            </div>
                            <div>
                              <Select label="Product variants" />
                            </div>
                          </div>
