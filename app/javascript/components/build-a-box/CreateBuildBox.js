...
const CreateBuildBox = ({ id, handleClose }) => {
  ...
  return (
    <Frame>
      <Page
        title={
          id ? 'Update Build a box Campaign' : 'Create Build a box Campaign'
        }
        breadcrumbs={[
          {
        ...
        {(campaignData || !id) && (
          <Formik
            ...
            onSubmit={(values, { setSubmitting }) => {
              ...
              formData.buildABoxCampaign.triggers = [
                { name: formData?.buildABoxCampaign?.triggers },
              ]; // Manipulate later
                            ...
                            <div className="search">
                              <SearchPlan
                                ...
                                error={
                                  ...
                                  touched.buildABoxCampaign?.sellingPlans
                                    ?.sellingPlanId &&
                                  errors.buildABoxCampaign?.sellingPlans
                                    ?.sellingPlanId
                                }
                              />
                            </div>
