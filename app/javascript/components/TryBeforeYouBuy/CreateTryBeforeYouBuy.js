...
const CreateTryBeforeYouBuy = () => {
  const category = "TRY_BEFORE_YOU_BUY";
  ...
  const initialValues = {
    ...
    _destroy: false,
    category: category,
    checkoutChargeType: 'PRICE',
    checkoutChargeValue: '',
    remaingBalanceChargeTrigger: 'TIME_AFTER_CHECKOUT',
                      ...
                      >
                        <FormLayout>
                          ...
                          <FormLayout.Group>
                            ...
                            />
                            {
                              plan.remaingBalanceChargeTrigger == "TIME_AFTER_CHECKOUT" && (
                                <span>
                                  Remaining Balance Charge Time After Checkout
                                  <input type='date'
                                    value={plan.remainingBalanceChargeTime}
                                    onChange={(e) =>
                                      setFieldValue(
                                        `sellingPlans[${index}].remainingBalanceChargeTime`,
                                        e.target.value
                                      )
                                    } />
                                </span>
...
export default CreateTryBeforeYouBuy;