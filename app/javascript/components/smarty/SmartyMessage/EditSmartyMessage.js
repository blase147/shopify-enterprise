...
const EditSmartyMessage = ({ id, handleClose }) => {
  ...
  const [getSmartySms, { data }] = useLazyQuery(getSmartySmsQuery, {
  ...
  useEffect(() => {
    if (data) {
      const variables = data?.fetchSmartyVariables?.map(
          ...
          <Layout>
            <Layout.Section>
              <div className="smarty-sms">
                ...
                <form class="">
                  <div
                    className="message-form edit-from"
              ...
              <div className="variable-section">
                <div className="variables">
                  ...
                  <p>
                    A set of custom keywords is provided to make your message
                    more personal and informative for your customers. To use
                    keywords is quite simple, you need to select from the
                    available keywords set and include it to your message body
                  ...
                  <div className="available-variables">
                    <p className="variable-text">Available Keywords</p>
                    {data &&
                      data?.fetchSmartyVariables?.map((variable) => (
            ...
            <Layout.Section oneThird>
              <div className="iphone-x">
                ...
                <div>
                  <span className="message">{formData.body.replaceAll(/[{{|}}]/g, '')}</span>
                </div>
              </div>
            </Layout.Section>
          </Layout>
