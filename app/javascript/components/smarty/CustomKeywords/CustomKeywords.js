...
const CustomKeywords = ({handleEditCustomKewords}) => {
  ...
  query ($offsetAttributes: OffsetAttributes!,$searchKey: String) {
      fetchCustomKeywords(offsetAttributes: $offsetAttributes, searchKey: $searchKey) {
              totalCount
                  customKeywords {
                      id
                      response
        ...
        <Card>
          <Card.Section>
            <div className="smarty-sms">
              ...
              <button className="cancelation-reason" onClick={()=>handleEditCancellation("")} >+ Add New Custom Keywords</button>
              <form class="">
                  ...
                  <>
                  {
                    data.fetchCustomKeywords.customKeywords.map(keyword=>(
                      <tr>
                        ...
                        <td><button className={`${keyword.status==="active" ? "active":"inactive"}-status-btn`}>{keyword.status}</button></td>
