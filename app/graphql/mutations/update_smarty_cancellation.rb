module Mutations
  class UpdateSmartyCancellation < Mutations::BaseMutation
    ...
    def resolve(params:)
      ...
      begin
        smarty_cancellation_reason = current_shop.smarty_cancellation_reasons.find_by(id: params[:id])
        smarty_cancellation_reason.update!(cancellation_params.except(:id))
